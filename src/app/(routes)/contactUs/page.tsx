      ...
      <section className="pt-32 pb-16 px-4">
        <div className="container mx-auto text-center">
          <h1 className="font-bold text-4xl font-serif">
            <span className="text-[#c8b180]  font-normal">Contact</span> Us
          </h1>
          ...
          <div className="bg-gradient-to-br from-[#c8b180]/10 to-[#a68b5b]/10 rounded-2xl p-6 border border-[#c8b180]/20">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 bg-[#c8b180] rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                ...
                <div>
                  ...
                  >
                    <p className="text-gray-600 font-sans">Office No.1001, Lynx Tower, Silicon Oasis</p>
                    <p className="text-gray-600 font-sans">Dubai – UAE</p>
                  </a>
                </div>
              </div>
