...
export const metadata: Metadata = {
  title: 'Terms and Conditions - Revantage',
  description: 'Terms and Conditions for Revantage - Read our terms of service and user agreement.',
};
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Welcome to Revantage. These Terms and Conditions ("Terms") govern your use of our website <a href="https://revantage.com" className="text-blue-600 hover:underline">revantage.com</a> and our services. By accessing or using our website, you agree to be bound by these Terms.
              </p>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-4">
                ...
                <p className="text-gray-700">Email: <a href="mailto:info@revantage.com" className="text-blue-600 hover:underline">info@revantage.com</a></p>
              </div>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4 font-serif">3. Services Provided</h2>
              <p className="text-gray-700 mb-4">Revantage provides the following services:</p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                The website and its content, including but not limited to text, graphics, logos, images, and software, are the property of Revantage or its licensors and are protected by copyright, trademark, and other intellectual property laws.
              </p>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                To the maximum extent permitted by law, Revantage shall not be liable for any direct, indirect, incidental, special, or consequential damages arising from your use of the website or services.
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                You agree to indemnify and hold harmless Revantage, its officers, directors, employees, and agents from any claims, damages, or expenses arising from your use of the website or violation of these Terms.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <p className="text-gray-700 mb-2"><strong>Revantage</strong></p>
                <p className="text-gray-700 mb-2">Office No.1001, Lynx Tower, Silicon Oasis</p>
                <p className="text-gray-700 mb-2">Dubai, UAE</p>
                <p className="text-gray-700 mb-2">Phone: <a href="tel:+97142345644" className="text-blue-600 hover:underline">+971 4 234 5644</a></p>
                <p className="text-gray-700 mb-2">Email: <a href="mailto:legal@revantage.com" className="text-blue-600 hover:underline">legal@revantage.com</a></p>
                <p className="text-gray-700">General Email: <a href="mailto:info@revantage.com" className="text-blue-600 hover:underline">info@revantage.com</a></p>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                These Terms, together with our Privacy Policy and any other legal notices published on our website, constitute the entire agreement between you and Revantage regarding your use of our website and services.
              </p>
            </section>
          </div>
        </div>
