        ...
        <div className="flex items-center gap-3 p-4 backdrop-blur-md">
          <div className="flex-1">
            <Input
              ...
              className="w-full text-gray-800 bg-white/90 border border-[#c8b180]/30 placeholder:text-gray-600 hover:border-[#c8b180]/50 transition-colors font-sans h-12"
            />
          </div>
          <Button
        ...
        <div className="container mx-auto">
          ...
          <div className="hidden md:grid grid-cols-1 md:grid-cols-8 gap-3 sm:gap-4 p-4 sm:p-6 bg-white/10 backdrop-blur-md rounded-xl sm:rounded-2xl border border-white/20 shadow-xl">
            ...
            <div>
              ...
              >
                <SelectTrigger className="w-full bg-white/90 border border-[#c8b180]/30 text-gray-800 h-12 sm:h-14 hover:border-[#c8b180]/50 transition-colors font-sans">
            ...
            <div className="flex gap-2">
              <Button
                onClick={toggleFilters}
                variant="outline"
                className="w-28 sm:w-32 h-12 sm:h-14 bg-white/90 hover:bg-white border border-[#c8b180]/30 text-gray-700 hover:border-[#c8b180]/50 transition-colors flex items-center justify-center gap-2 font-sans text-xs sm:text-sm"
              >
              ...
              <Button
                onClick={handleSearch}
                className="h-12 w-12 sm:h-14 sm:w-14 bg-gradient-to-r from-[#c8b180] to-[#a68b5b] hover:from-[#a68b5b] hover:to-[#8b7350] text-white flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-0.5"
              >
                <Icon
