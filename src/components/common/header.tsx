    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <nav className="container mx-auto flex items-center justify-between px-6 h-16">
        ...
        <div className="flex items-center space-x-3 flex-shrink-0">
          ...
          {/* Mobile Menu Button */}
          <div
            className="lg:hidden cursor-pointer transition-colors duration-200 text-gray-700 hover:text-[#c8b180]"
      ...
      >
        ...
        <nav className="flex flex-col p-4 sm:p-6 space-y-2 bg-white">
          {navLinks.map((link, i) => {
              ...
              return (
                <div key={i} className="space-y-2">
                  <button
                    ...
                    className={cn(
                      "flex items-center justify-between w-full text-left text-gray-700 hover:text-[#c8b180] transition-all duration-200 py-3 px-4 rounded-lg hover:bg-gray-50 border border-transparent hover:border-gray-200",
                      pathname === link.href && "text-[#c8b180] font-medium bg-gray-50 border-gray-200"
                    )}
                  >
                  ...
                  <div className={cn(
                    ...
                    <div className="pl-4 space-y-1 border-l-2 border-[#c8b180]/30 bg-white rounded-r-lg p-2 border border-gray-100">
                      {services.map((service, serviceIndex) => (
                        ...
                        >
                          <div className="flex-shrink-0 transition-colors duration-200 group-hover:text-[#c8b180]">
                            {service.icon}
                          </div>
                          <span className="text-gray-700 font-medium text-sm group-hover:text-[#c8b180] transition-colors duration-200">
                            {service.name}
                          </span>
                        </Link>
                      ))}
            ...
            <Link
              ...
              href={link.href}
              className={cn(
                  "text-gray-700 hover:text-[#c8b180] transition-all duration-200 py-3 px-4 rounded-lg hover:bg-gray-50 border border-transparent hover:border-gray-200 font-medium",
                  pathname === link.href && "text-[#c8b180] font-medium bg-gray-50 border-gray-200"
              )}
                onClick={() => setIsOverlayOpen(false)}
            >
        ...
        <div className="p-4 sm:p-6 border-t border-gray-200 bg-white space-y-4 sm:space-y-6">
          ...
          <div className="flex items-center justify-center space-x-2 p-3 bg-white rounded-lg border border-gray-200 shadow-sm">
            <Globe className="h-4 w-4 text-[#c8b180]" />
