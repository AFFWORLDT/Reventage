        ...
        <div className="max-w-4xl">
          ...
          <div className="mb-8">
            <nav className="text-white text-sm">
              ...
              <span>Services</span>
              <span className="mx-2">/</span>
              <span className="underline">Property Valuation</span>
            </nav>
          </div>

          {/* Main Heading */}
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight text-left font-serif">
            Know your property's <span className="text-[#c8b180]">true worth</span>
          </h1>

          {/* Subheading */}
          <p className="text-xl md:text-2xl text-white mb-8 max-w-3xl leading-relaxed text-left">
            Accurate, expert valuations backed by data, experience, and local insights.
          </p>
