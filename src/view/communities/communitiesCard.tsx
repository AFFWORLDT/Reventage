  ...
  return (
    ...
    >
      <CardContent className="p-0 h-full relative">
        ...
        <div className="h-2/5 bg-gradient-to-br from-white via-[#F8F6F0] to-white p-6 flex flex-col justify-between">
          ...
          <Link
            ...
            className={cn(
              ...
              "after:bg-[#c8b180] after:transition-all after:duration-300 group-hover:after:w-full"
            )}
        ...
        <div className="absolute inset-0 rounded-3xl border border-transparent bg-gradient-to-r from-[#c8b180]/20 via-transparent to-[#a68b5b]/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
      </CardContent>
    </Card>
  );
}
