    ...
    <div className="luxury-bg">
      ...
      >
        ...
        <div className="relative z-30 text-white px-4 mt-[60vh]">
          ...
          {property?.price && (
            <p className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 tracking-wide text-primary">
              AED {property.price.toLocaleString()}{property?.priceType ? `/${property.priceType}` : ''}
            </p>
          )}
              ...
              <>
                ...
                <div className="flex items-center gap-4 bg-gradient-to-r from-[#F8F6F0] to-[#F2EEE8] px-4 py-3 rounded-xl border border-[#E5E1D8] shadow-lg">
                  <div className="relative">
                    <div className="w-12 h-12 rounded-full overflow-hidden border-3 border-[#c8b180] shadow-md">
                  ...
                  <div className="flex gap-2">
                    ...
                    <a
                      ...
                      className="w-10 h-10 bg-[#c8b180] hover:bg-[#a68b5b] rounded-full flex items-center justify-center transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
                    >
